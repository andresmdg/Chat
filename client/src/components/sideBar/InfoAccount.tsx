export default function InfoAccount(params: {
  ...
  return (
    <div
      ...
      <div className='relative h-6 justify-center items-center gap-4 inline-flex hover:bg-[#8080804f] w-full py-1 rounded-lg group'>
        <div className='w-5 h-5 bg-green-500 rounded-full animate-ping' />
        <p className="text-slate-400 font-bold font-['Roboto'] select-none">
          En linea
        </p>
